    ...
    <b-form>
      <b-form-group label="Titulo:" label-for="subject">
        <b-form-input id="subject" v-model="form.subject" type="text" placeholder="Ex: lavar carro" required
          autocomple="off"></b-form-input>
      </b-form-group>

       <b-form-group label="Descrição:" label-for="description">
        <b-form-textarea id="description" v-model="form.description" type="text" placeholder="Ex: preciso lavar o carro" required
          autocomple="off"></b-form-textarea>
      </b-form-group>
  ...
  export default {
    ...
    methods: {
      saveTask(){
        ...
        this.showToast('success', "Sucesso", "Tarefa criada com sucesso!");localStorage.setItem("tasks", JSON.stringify(tasks));
        this.$router.push({name: "list"});
      }
    }
  }
